<template>
  <div class="w-[40rem]">
    <div class="pb-4 font-bold text-center">Limite de dedução à coleta por categoria</div>
              ...
              >
                <template v-if="slotProps.data.multiple">
                  <div class="flex flex-wrap justify-center items-center gap-1">
                    <i
                      v-for="(icon, index) in slotProps.data.icons"
                      :key="index"
...
const products = ref([
    ...
    meterValue: [
      {
        value: getTaxCreditPercentage(
          props.maxTaxcreditsPerCategory.generalFamilyExpenses.value,
          props.maxTaxcreditsPerCategory.generalFamilyExpenses.max,
        ),
      },
    ],
  },
  {
    ...
    meterValue: [
      {
        value: getTaxCreditPercentage(
          props.maxTaxcreditsPerCategory.healthExpenses.value,
          props.maxTaxcreditsPerCategory.healthExpenses.max,
        ),
      },
    ],
  },
  {
    ...
    meterValue: [
      {
        value: getTaxCreditPercentage(
          props.maxTaxcreditsPerCategory.educationExpenses.value,
          props.maxTaxcreditsPerCategory.educationExpenses.max,
        ),
      },
    ],
  },
  {
    ...
    meterValue: [
      {
        value: getTaxCreditPercentage(
          props.maxTaxcreditsPerCategory.rentExpenses.value,
          props.maxTaxcreditsPerCategory.rentExpenses.max,
        ),
      },
    ],
  },
  {
    ...
    meterValue: [
      {
        value: getTaxCreditPercentage(
          props.maxTaxcreditsPerCategory.careHomeExpenses.value,
          props.maxTaxcreditsPerCategory.careHomeExpenses.max,
        ),
      },
    ],
  },
  {
    ...
    meterValue: [
      {
        value: getTaxCreditPercentage(
          props.maxTaxcreditsPerCategory.otherDeductions.value,
          props.maxTaxcreditsPerCategory.otherDeductions.max,
        ),
      },
    ],
  },
